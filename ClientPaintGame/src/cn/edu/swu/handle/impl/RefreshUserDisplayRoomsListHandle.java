...
public class RefreshUserDisplayRoomsListHandle implements ResponseHandle {
	...
	public void handle(Response response, ObjectInputStream ois,
		...
		if(1==RoomFrame.everyServerInnerInterfaceState){
			
			RoomFrame.labelLeftPanelRightRooms.removeAll();
			RoomFrame.labelLeftPanelRightRooms.repaint();
